...
DEFAULT_ATTACK = 5  # стандартное значение атаки
DEFAULT_DEFENCE = 10  # стандартное значение защиты
DEFAULT_STAMINA = 80  # стандартное значение выносливости
...
def start_training(character) -> str:
    """Тренировка навыков: атака, защита, суперумение."""
    ...
    # добавили команды для тренировки в словарь
